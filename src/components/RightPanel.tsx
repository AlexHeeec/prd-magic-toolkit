  ...
  return (
    <div className="panel-transition w-full h-full flex flex-col bg-white rounded-xl border border-primary/20 shadow-sm overflow-hidden">
      <Tabs defaultValue="chat" className="w-full h-full flex flex-col">
        ...
        <TabsContent value="chat" className="flex-1 flex flex-col p-4 pt-0 overflow-auto">
          {activeTask ? (
            <>
        ...
        <TabsContent value="versions" className="flex-1 flex flex-col p-4 pt-0 overflow-auto">
          {activeTask ? (
